const quotes = [
  {
    text: 'However bad life may seem, there is always something you can do and succeed at. Where there\'s life, there\'s hope.',
  ...
  {
    text: 'Before you achieve something, you must study it first.',
...
const animateQuote = () => {
  quoteContainer.classList.add('animate__animated', 'animate__jackInTheBox');
  setTimeout(() => {
    quoteContainer.classList.remove('animate__animated', 'animate__jackInTheBox');
  }, 1000);
}
